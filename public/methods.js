...
var methods = {
    ...
    restaurants: function() {
        ...
        $.ajax({
            method: "GET",
            url: "/restaurants/?_sort=views&_order=DESC"
            ...
            $('span[data-attr="category"]').on('click', function(e) {
                ...
                $('.modal.small.select-category[data-id="' + id + '"]').modal({
                    transition: 'scale',
                    closable: false,
                    onDeny: function() {
                        return false;
